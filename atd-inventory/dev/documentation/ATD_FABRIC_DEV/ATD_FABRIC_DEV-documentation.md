...
| --- | ---- | ---- | ------------- | -------- | -------------------------- |
| ATD_FABRIC_DEV | l3leaf | s1-leaf1 | 192.168.0.12/24 | CEOS-LAB | Provisioned |
| ATD_FABRIC_DEV | l3leaf | s1-leaf2 | 192.168.0.13/24 | CEOS-LAB | Provisioned |
| ATD_FABRIC_DEV | l3leaf | s1-leaf3 | 192.168.0.14/24 | CEOS-LAB | Provisioned |
| ATD_FABRIC_DEV | l3leaf | s1-leaf4 | 192.168.0.15/24 | CEOS-LAB | Provisioned |
| ATD_FABRIC_DEV | spine | s1-spine1 | 192.168.0.10/24 | CEOS-LAB | Provisioned |
| ATD_FABRIC_DEV | spine | s1-spine2 | 192.168.0.11/24 | CEOS-LAB | Provisioned |
...
| POD | Node | Loopback0 |
| --- | ---- | --------- |
| ATD_FABRIC_DEV | s1-leaf1 | 192.0.255.3/32 |
| ATD_FABRIC_DEV | s1-leaf2 | 192.0.255.4/32 |
| ATD_FABRIC_DEV | s1-leaf3 | 192.0.255.5/32 |
| ATD_FABRIC_DEV | s1-leaf4 | 192.0.255.6/32 |
| ATD_FABRIC_DEV | s1-spine1 | 192.0.255.1/32 |
| ATD_FABRIC_DEV | s1-spine2 | 192.0.255.2/32 |
...
| POD | Node | Loopback1 |
| --- | ---- | --------- |
| ATD_FABRIC_DEV | s1-leaf1 | 192.0.254.3/32 |
| ATD_FABRIC_DEV | s1-leaf2 | 192.0.254.3/32 |
| ATD_FABRIC_DEV | s1-leaf3 | 192.0.254.5/32 |
| ATD_FABRIC_DEV | s1-leaf4 | 192.0.254.5/32 |
