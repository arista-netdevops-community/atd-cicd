...
| --------- | --------------- | ------------ | --------- |
| LEAF_PAIR_1 | Vlan4094 | 172.30.254.0 | Port-Channel1 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  172.30.253.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.30.254.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 172.30.253.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 172.30.253.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.30.253.0 description s2-leaf1
   neighbor 172.30.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.4 remote-as 65001
   neighbor 172.30.255.4 description s2-spine1_Ethernet3
   neighbor 172.30.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.6 remote-as 65001
   neighbor 172.30.255.6 description s2-spine2_Ethernet3
