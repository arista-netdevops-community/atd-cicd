...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_S1-CORE1_Ethernet1 | routed | - | 10.255.0.0/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_S2-CORE2_Ethernet4 | routed | - | 10.255.0.7/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_S1-CORE1_Ethernet6 | routed | - | 10.255.0.5/31 | default | 1500 | False | - | - |
...
| 10.255.0.1 | 65501 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.0.4 | 65501 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.0.6 | 65505 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65502
   ...
   neighbor 10.255.0.1 remote-as 65501
   neighbor 10.255.0.1 description s1-core1_Ethernet1
   neighbor 10.255.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.4 remote-as 65501
   neighbor 10.255.0.4 description s1-core1_Ethernet6
   neighbor 10.255.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.6 remote-as 65505
   neighbor 10.255.0.6 description s2-core2_Ethernet4
