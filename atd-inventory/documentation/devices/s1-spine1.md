...
| 172.30.255.17 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.30.255.21 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 172.30.255.17 remote-as 65103
   neighbor 172.30.255.17 description s1-brdr1_Ethernet2
   neighbor 172.30.255.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.255.21 remote-as 65103
   neighbor 172.30.255.21 description s1-brdr2_Ethernet2
